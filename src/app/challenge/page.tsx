...
export default function Home() {
    ...
    // 챌린지 상태 배열
    const [ challengeState, setChallengeState ] = useState([true, true, true, true, false, false, false, false, false, false]);
    
    const stampImages = [
      "stamp1.svg", "stamp2.svg", "stamp3.svg", "stamp4.svg", "stamp5.svg",
      "stamp1.svg", "stamp2.svg", "stamp3.svg", "stamp4.svg", "stamp5.svg"
    ];
          ...
          <div>
            ...
            <div className="w-full h-[80px] flex justify-center gap-[30px] mb-[50px]"> {/* 123일차 */}
              {challengeState.slice(0, 3).map((done, idx) => (
                ...
                >
                  <p className="text-[14px] leading-[130%] tracking-[-0.8px]">{`${idx + 1}일차`}</p>
                  {done ? (<img src={stampImages[idx]} alt="스탬프" />) : (<img src="lock.svg" alt="잠금" />)}
            ...
            <div className="w-full h-[80px] flex justify-center gap-[30px] mb-[50px]"> {/* 45일차 */}
              {challengeState.slice(3, 5).reverse().map((done, idx) => (
                <div
                  key={3 + (1 - idx)}
                  className={`w-[80px] border-[2px] border-[#01274F] rounded-[9999px] 
                  ${done ? "bg-[#FFFFFF]" : "bg-[#E5E5E5] border-dotted"} 
                  flex flex-col justify-center items-center`}
                >
                  <p className="text-[14px] leading-[130%] tracking-[-0.8px]">{`${5 - idx}일차`}</p>
                  {done
                    ? (<img src={stampImages[4 - idx]} alt="스탬프" />) : (<img src="lock.svg" alt="잠금" />)}
                  <p className="text-[12px] leading-[130%] tracking-[-0.8px]">
                    {done ? "완료!" : ""}
                  </p>
                </div>
            ...
            <div className="w-full h-[80px] flex justify-center gap-[30px] mb-[50px]"> {/* 678일차 */}
              {challengeState.slice(5, 8).map((done, idx) => (
                <div
                  ...
                  flex flex-col justify-center items-center`}
                >
                  <p className="text-[14px] leading-[130%] tracking-[-0.8px]">{`${idx + 6}일차`}</p>
                  {done ? (<img src={stampImages[idx + 5]} alt="스탬프" />) : (<img src="lock.svg" alt="잠금" />)}
                  <p className="text-[12px] leading-[130%] tracking-[-0.8px]">
                    {done ? "완료!" : ""}
                  </p>
                </div>
            ...
            <div className="w-full h-[80px] flex justify-center gap-[30px] mb-[50px]"> {/* 910일차 */}
              {challengeState.slice(8, 10).reverse().map((done, idx) => (
                <div
                  key={8 + (1 - idx)}
                  className={`w-[80px] border-[2px] border-[#01274F] rounded-[9999px] 
                  ${done ? "bg-[#FFFFFF]" : "bg-[#E5E5E5] border-dotted"} 
                  flex flex-col justify-center items-center`}
                >
                  <p className="text-[14px] leading-[130%] tracking-[-0.8px]">{`${10 - idx}일차`}</p>
                  {done ? (
